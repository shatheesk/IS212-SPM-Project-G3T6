...
import json
from app import app, db, course, employee, cohort, badges, enrollment, enrollmentRequest
...
class TestProcessRequest(TestApp):
    def test_process_request(self):
        # add data to course
        course1 = course(courseName="Big questions", courseImage="images/course_4.jpg", courseDescription="This course introduces learners to the biggest questions in life", prerequisite="Finance and accounting")
        ...
        enrollmentRequest1 = enrollmentRequest(courseNameRequest="Big questions", cohortNameRequest="G1", learnerName="Shakira")
        ...
        result = enrollment.query.filter_by(employeeName="Shakira", courseNameEnrolled="Big questions", cohortNameEnrolled="G1").first()
...
class TestDeleteRequest(TestApp):
    def test_delete_request(self):
        ...
        result = enrollmentRequest.query.filter_by(courseNameRequest="Big questions", cohortNameRequest="G1", learnerName="Shakira").first()
...
class TestViewAllBadges(TestApp):
    def test_view_all_badges(self):
        ...
        badges1 = badges(employeeName="Alice", badges="Introduction to life", cohortName="G0")
        badges2 = badges(employeeName="Alice", badges="Introduction to python", cohortName="G0")
        badges3 = badges(employeeName="Alice", badges="Introduction to HTML", cohortName="G0")
...
class TestViewAllEnrolledCourses(TestApp):
    def test_viewAllEnrolledCourses(self):
        ...
        enrollment1 = enrollment(employeeName="Alice", courseNameEnrolled="Introduction to life", cohortNameEnrolled="G1", recent=1)
        enrollment2 = enrollment(employeeName="Alice", courseNameEnrolled="Introduction to flask", cohortNameEnrolled="G1", recent=1)
        enrollment3 = enrollment(employeeName="Alice", courseNameEnrolled="Introduction to python", cohortNameEnrolled="G1", recent=1)
...
class TestViewAllRequests(TestApp):
    def test_viewAllRequests(self):
        ...
        enrollmentRequest1 = enrollmentRequest(courseNameRequest="Introduction to python", cohortNameRequest="G1", learnerName="Shakira")
